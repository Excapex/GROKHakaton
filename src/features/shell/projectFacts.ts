...
export const FIELDS_SEPARATION_NOTE =
  'Disciplina predmeta i stručni postupak pregleda su odvojena polja. Predmet može biti arhitektonski, a pregled se vodi po nekom drugom stručnom modulu.'
