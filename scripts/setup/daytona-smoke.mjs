...
try {
  const result=await sandbox.process.executeCommand('python -c "import fitz, docx, openpyxl, yaml, jsonschema; print(\'SAGLASNIK_IMPORTS_OK\')" && pdftoppm -v && libreoffice --version',undefined,undefined,60);
